...
document.addEventListener('DOMContentLoaded', function () {
    ...
    facultyForm.addEventListener('submit', function (e) {
        ...
        const facultyData = {
            ...
            department: 'CBAA', // Automatically set department as "CBAA"
        ...
        if (editingDocId) {
            ...
            db.collection('Faculty_Data')
              ...
              .then((snapshot) => {
                  ...
                  const nextId = `CBAAFaculty_${String(count + 1).padStart(3, '0')}`; // Generate next ID (CBAAFaculty_001, etc.)
    ...
    /**
     * Sets up a real-time listener to the CBAA_Faculty collection.
