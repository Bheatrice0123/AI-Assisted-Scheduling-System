...
document.addEventListener('DOMContentLoaded', function () {
    ...
    facultyForm.addEventListener('submit', function (e) {
        ...
        const facultyData = {
            ...
            department: 'COE', // Automatically set department as "COE"
        ...
        if (editingDocId) {
            ...
            db.collection('Faculty_Data')
              ...
              .then((snapshot) => {
                  ...
                  const nextId = `COEFaculty_${String(count + 1).padStart(3, '0')}`; // Generate next ID (COEFaculty_001, etc.)
    ...
    /**
     * Sets up a real-time listener to the COE_Faculty collection.
