...
document.addEventListener('DOMContentLoaded', function () {
    ...
    facultyForm.addEventListener('submit', function (e) {
        ...
        const facultyData = {
            ...
            department: 'COED', // Automatically set department as "COED"
        ...
        if (editingDocId) {
            ...
            db.collection('Faculty_Data')
              ...
              .then((snapshot) => {
                  ...
                  const nextId = `COEDFaculty_${String(count + 1).padStart(3, '0')}`; // Generate next ID (COEDFaculty_001, etc.)
    ...
    /**
     * Sets up a real-time listener to the COED_Faculty collection.
